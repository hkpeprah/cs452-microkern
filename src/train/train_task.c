        ...
        switch (request.type) {
            case TRM_GOTO_AFTER:
                ...
                if (request.arg0 == NULL) {
                    ...
                    if (reserveTrack(&train, getStoppingDistance(train.id, GOTO_SPEED, 0) - train.currentEdge->dist) <= 0) {
            ...
            case TRM_SPEED:
                ...
                if (speed == 0) {
                    ...
                    if (reserveTrack(&train, getStoppingDistance(train.id, speed, 0) - train.currentEdge->dist) <= 0) {
