...
void initTrainSpeeds() {
    ...
    unsigned int measured_stopping_distances[][MEASUREMENT_TOTAL] = {
        {0, 150, 150, 150, 230, 300, 360, 450, 500, 560, 640, 680, 750, 790, 820},
        {0, 170, 170, 170, 260, 310, 390, 480, 547, 633, 703, 768, 850, 850, 850},
        {0, 160, 160, 160, 200, 280, 360, 440, 560, 620, 700, 775, 855, 935, 960},
        {0, 90, 90, 90, 160, 240, 310, 380, 450, 510, 570, 650, 710, 780, 790},
